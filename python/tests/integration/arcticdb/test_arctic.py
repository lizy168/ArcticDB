...
@pytest.mark.parametrize("checksum_required", [0, 1])
def test_s3_delete_survives_crc64nvme_hostile_backend(s3_storage, lib_name, checksum_required):
    ...
    try:
        ...
        with config_context("S3Storage.DeleteObjectsRequestChecksumRequired", checksum_required):
...
@pytest.mark.parametrize("checksum_required", [0, 1])
def test_s3_delete_objects_checksum_required_real_s3(real_s3_storage, lib_name, checksum_required):
